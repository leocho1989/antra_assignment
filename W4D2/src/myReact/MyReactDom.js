...
const render = (reactElement, domElement) => {
  ...
  if ((typeof reactElement === "string") | (typeof reactElement === "number")) {
    ...
    if (typeof type === "function") {
      console.log("function Props", type);
      const curFunctionReactElement = new type(props);
      console.log("function", curFunctionReactElement);
      render(curFunctionReactElement, domElement);
      return;
    }
